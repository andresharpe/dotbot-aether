...
**Window Conduit — Pixoo** (`~repos/Pixoo`)
...
**Sonic & Ambient Conduit — JblPartyBox** (`~repos/JblPartyBox`)
...
**Console Conduit — StreamDeck** (`~repos/StreamDeck`)
...
**Counter Conduit — TextPrinter** (`~repos/TextPrinter`)
...
A single add-in collection repo containing all conduit plugins. Structure:
